...
public class ViriosiumToolShovelItem extends ViriaemModElements.ModElement {
	@ObjectHolder("viriaem:viriosium_shovel")
	public static final Item block = null;
	public ViriosiumToolShovelItem(ViriaemModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("viriosium_shovel"));
	}
}
